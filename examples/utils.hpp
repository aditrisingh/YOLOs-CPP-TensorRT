...
inline void printUsage(const std::string& programName, 
    ...
    std::cout << "\n╔════════════════════════════════════════════════════╗" << std::endl;
    std::cout << "║  YOLOs-TRT " << taskType << " Example" << std::endl;
    std::cout << "╚════════════════════════════════════════════════════╝" << std::endl;
    std::cout << "\nUsage: " << programName << " [model_path] [input_path] [labels_path]" << std::endl;
    std::cout << "\nArguments:" << std::endl;
    std::cout << "  model_path   : Path to TensorRT engine (default: " << defaultModel << ")" << std::endl;
    ...
    std::cout << "  " << programName << " ../models/yolo11n.trt" << std::endl;
    std::cout << "  " << programName << " ../models/yolo11n.trt ../data/image.jpg" << std::endl;
    std::cout << "  " << programName << " ../models/yolo11n.trt ../data/ ../models/coco.names" << std::endl;
    std::cout << std::endl;
}
