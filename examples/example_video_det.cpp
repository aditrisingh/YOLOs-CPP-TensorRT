/**
 * @file example_video_det.cpp
 * @brief Standard object detection on videos using YOLO models
 * @details Processes video files frame by frame with object detection
 */
...
int main(int argc, char* argv[]) {
    ...
    utils::printUsage(argv[0], "Video Detection", modelPath, videoPath, labelsPath);
    ...
    try {
        ...
        // Display metrics
        utils::printMetrics("Video Detection", duration.count(), avgFps);
