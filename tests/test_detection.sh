#!/bin/bash
# ============================================================================
# YOLOs-TRT Detection Test Runner
# ============================================================================
# Pipeline:
#   1. Download test images
#   2. Install Python deps (uv + ultralytics)
#   3. Download .pt models, export to ONNX
#   4. Convert ONNX to TensorRT engines
#   5. Generate Python ground truth
#   6. Build C++ test suite
#   7. Run C++ inference and compare results
# ============================================================================
set -e
...
print_header "YOLOs-TRT Detection Test"
